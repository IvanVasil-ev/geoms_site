...
function t_zoomHandler(t) {
  ...
  var e = document.querySelector('.t-zoomer__container'),
    ...
    a = (n.classList.add('t-carousel__zoomer__inner'), document.createElement('div')),
    a =
  ...
  i && (i.style.display = 'flex'),
    ...
    t_zoom_lockScroll(),
  (window.t_zoom__isMobile || 'ontouchend' in document) &&
  (t_zoom_initSwipe(), t_zoom_initCloseSwipe()),
...
function t_zoom_initSwipe() {
  ...
  (t.on('panstart', function () {
    ...
    'y' !== t.getAttribute('data-on-transition')
      ? t && ((n = t.getBoundingClientRect().left), (t.style.transition = 'none'))
      : (n = null),
    ...
    t.on('panmove', function (t) {
      ...
      n && ((o = n + t.deltaX), (e.style.transform = 'translateX(' + o + 'px)')))
    }),
    t.on('panend', function (t) {
      ...
      ((r.style.transition = ''),
        ...
        0.6 < (o = (o - Math.abs(a + e)) / n / 1e3) ? (o = 0.6) : o < 0.2 && (o = 0.2),
...
function t_zoom__addingImgsIntoCarousel(t) {
  var e = t.closest('.r'),
    s = e
      ? e.querySelectorAll('.t-zoomable:not(.t-slds__thumbs_gallery):not(.tn-atom__slds-img)')
      : [],
    _ =
  ...
  Array.prototype.forEach.call(s, function (t, e) {
    var o,
      ...
      t =
        ...
        ((a = t.getAttribute('title') || ''), (i = t.getAttribute('data-img-zoom-descr') || '')),
        a &&
...
function t_zoom__createAndLoopSlider(t) {
      ...
      var e = t.querySelector('.t-carousel__zoomer__img'),
        ...
        t =
          ...
          t && (t.style.height = r + 'px'),
            (e.style.maxHeight = document.documentElement.clientHeight - (r + n) + 'px'),
  ...
  (t = (r = (o = t.getAttribute('data-img-zoom-url'))
    ? document.querySelector(
      '.t-carousel__zoomer__img[' + (i ? 'data-original' : 'src') + '="' + o + '"]'
    )
    : null)
...
function t_zoom_initCloseSwipe() {
  ...
  t.on('panstart', function () {
    ...
    t.on('panmove', function (t) {
      ...
      ;('y' === n.getAttribute('data-on-drag') && 'y' !== r.getAttribute('data-on-drag')) ||
      !((-120 < t.angle && t.angle < -60) || (t.angle < 120 && 60 < t.angle)) ||
      1 !== t.maxPointers ||
      a ||
  ...
  (t.setAttribute('data-zoom-scale-init', 'y'),
    a.addEventListener(
      ...
      function (t) {
        ...
        ;((window.t_zoom__isMobile && t.target.closest('.t-zoomer__scale') && n) ||
          (!window.t_zoom__isMobile &&
            n &&
            !t.target.closest('.t-zoomer__close, .t-carousel__zoomer__control'))) &&
...
function t_zoom_getTouchEventXY(t) {
  ...
  return (
    ('touchstart' !== t.type &&
      ...
      'touchend' !== t.type &&
      'touchcancel' !== t.type) ||
    ((t = t.touches[0] || t.changedTouches[0]), (e.x = t.pageX), (e.y = t.pageY)),
      e
  )
}
...
function t_zoom_unscale() {
  var t,
    e,
    o = document.querySelectorAll('.t-zoomer__wrapper.scale-active, .t-carousel__zoomer__inner'),
    o =
  ...
  o &&
  ((e = o.querySelector('.t-carousel__zoomer__img')),
    (t = o.querySelector('.t-zoomer__comments')),
  n &&
  ((n = n.offsetHeight - o.offsetHeight),
    ...
    (e.style.left = ''),
    (e.style.top = ''),
    (e.style.maxHeight = 'calc(100vh - ' + (n + t) + 'px)'))),
  void 0 !== o.offsetLeft &&
  void 0 !== o.offsetTop &&
  ((e = o.offsetLeft), (r.style.transform = 'translateX(' + -e + 'px)')),
    setTimeout(function () {
      r.style.transition = ''
    }, 100)
}
...
function t_zoom_luma_rgb(t) {
  ...
  return e.length < 3 || 0.2126 * e[0] + 0.7152 * e[1] + 0.0722 * e[2] < 128 ? 'black' : 'white'
}
