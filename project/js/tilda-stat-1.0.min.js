!(function () {
    ...
    if (!(c < 10))
      for (var s = [10, 25, 50, 75, 90], l = 0; l < s.length; l++) {
        var u = s[l],
          g = s.length - 1
        if (0 === l && c >= u && !m['p' + u])
          (f.page = '/tilda/scroll/' + u + '/'), window.tildastat('pageview'), (m['p' + u] = !0)
        else if (c >= u - 1) {
          if (0 === m['p' + u]) {
            ;(f.page = '/tilda/scroll/' + u + '/'),
              window.tildastat('pageview'),
              (m['p' + u] = setTimeout(function () {
                clearTimeout(m['p' + u]), (m['p' + u] = -1)
              }, 5e3))
            break
          }
          if (((l !== g && c < s[l + 1]) || l === g) && -1 === m['p' + u]) {
            m['p' + u] = 0
            break
          }
        }
  ...
  function s() {
    ...
    if (navigator.plugins) {
      var t,
        n = ''
      for (t = 0; t < navigator.plugins.length; t++) n += navigator.plugins[t].filename
      e += 'pl' + n
    }
    return (
      (e += 'pr' + window.devicePixelRatio),
        (e = c((e += 'w' + window.winWidth + 'h' + window.winHeight)))
    )
  }
  function l() {
    ;(E = n('tildauid')),
      (_ = n('tildasid')),
      h ? (E || (E = 'simple'), _ || (_ = 'simple')) : (E || (E = t()), _ || (_ = t()))
  }
  function u() {
    if (!h) {
      var e = 7776e3
      o('tildauid', E, { expires: 7776e3, path: '/' }),
        o('tildasid', _, { expires: 1800, path: '/' })
    }
  }
  function g(t) {
    ...
    l(),
      ...
      (f.user_language = window.navigator.userLanguage || window.navigator.language),
    e &&
    ...
    if (n > '?' && ((f.pagequery = n.substring(1).toLowerCase()), ~f.pagequery.indexOf('utm_'))) {
      var o,
        i = f.pagequery.split('&')
      Array.prototype.forEach.call(i, function (e) {
        ;(o = e.split('=')).length > 1
          ? 'utm_referrer' !== o[0] || (f.referrer && !~f.referrer.indexOf('ohio8.v'))
            ? (f.params[o[0]] = o[1])
            : (f.referrer = o[1])
          : (f.params[o[0]] = '')
      })
  ...
  function p(e) {
    ...
    '/' === f.page.substring(0, 1) && (f.page = window.location.hostname + f.page)
    var a = w(f),
    ...
    ((f.referrer = f.page), h || o('previousUrl', f.page, { path: '/', expires: 1800 })),
      (f.page = ''),
  ...
  window.tildastat = function (e, t) {
    ...
    switch ((t && i(f, t), e)) {
      ...
      case 'scroll':
        ...
        window.addEventListener('scroll', t_throttle(r, 1e3))
        break
      case 'cookieenabled':
        ;(h = !1),
        l(),
  ...
  var f = {},
    m = { p10: 0, p25: 0, p50: 0, p75: 0, p90: 0 },
    v = !0,
  ...
  window.tildastat('create'),
    ...
    setInterval(function () {
      if (
        ...
        !0 !== window.t_isloadingerrorsjsfile
      ) {
        window.t_isloadingerrorsjsfile = !0
