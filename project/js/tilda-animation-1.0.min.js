...
function t_animate__startAnimation() {
  ...
  (t_animate__setAnimationState(i, r, o),
    ...
    'IntersectionObserver' in window && !t
      ? (i.length &&
      ((e = new IntersectionObserver(function (t, a) {
        t.forEach(function (t) {
          var e
          t.isIntersecting &&
          ((e = t.target),
            a.unobserve(e),
            (t = e.querySelectorAll('.t-animate')),
            ...
            t_animate__makeSectionButtonWait(e),
            t_animate__saveSectionHeaderStartTime(e),
            Array.prototype.forEach.call(t, function (t) {
      ...
      o.forEach(function (t) {
        ...
        e = new IntersectionObserver(function (t, n) {
          t.forEach(function (t) {
            ...
            (n.unobserve(a),
              (t =
                -1 !== (t = a.style.transitionDelay || '0ms').indexOf('ms')
                  ? parseInt(t) + 250
                  : 1e3 * parseFloat(t) + 250),
            a.demandTransform &&
      ...
      ((a = function () {
        ...
        window.addEventListener('resize', t_throttle(a)),
        setInterval(a, 5e3),
...
function t_animate__animateChainItemsOnScroll(t, e) {
  ...
  for (var l = 0; l < a.length; l++) {
    var c = a[l],
      m = t.itemsOffsets[l]
    if (!(m < e)) break
    m !== r && (c.classList.add('t-animate__chain_first-in-row'), (n = ++i), (r = m))
    var _ = 0.16 * n + o + s
    ;(c.style.transitionDelay = _ + 's'),
      c.classList.remove('t-animate_wait'),
      c.classList.add('t-animate_started'),
      c.setAttribute('data-animate-start-time', Date.now() + 1e3 * _),
    c[0] === a[a.length - 1] && t_animate__checkSectionButtonAnimation(t, _),
    +m == +r && n++,
      a.splice(l, 1),
...
function t_animate__getSectionHeadDealy(t) {
  ...
  if (e) {
    ...
    if (Date.now() - e <= 160) return (t = 0.16)
  }
  if (a) {
    a = a.getAttribute('data-animate-start-time') || 0
    if (Date.now() - a <= 160) return (t = 0.16)
  }
  return t
}
  ...
  Array.prototype.forEach.call(t, function (t) {
    ...
    Array.prototype.forEach.call(r, function (t) {
      ...
      t.querySelectorAll('div[data-customstyle="yes"]').length
        ? ((e = (a = t.querySelector('div[data-customstyle="yes"]')) ? a.innerHTML : ''),
          (n = t.getAttribute('style') || ''),
        (a = (a = t.querySelector('div[data-customstyle]')) ? a.getAttribute('style') : '') &&
        (n += a),
      ...
      (i = i
        ...
        .join(';')),
    t.getBoundingClientRect().top + window.pageYOffset < o - 500 ||
    (e.length &&
      ((n = a =
        e
          .replace(/<br>/g, ' ')
          ...
          .replace(/(\d)(?=\d) /g, '$1')
          .trim()),
      -1 === e.indexOf(a) && (n = a = a.split(' ')[0]),
      '' !== a &&
      (t.setAttribute('data-animate-number-count', e),
        t_animate__changeNumberOnZero(t, e.replace(n, 'num')),
...
function t_animate__animateNumbers(e) {
  ...
  var m,
    ...
    f,
    y,
    d = e.querySelector('.t-animate__number')
  r[0] &&
  ((m = Number(r[0]) || 0),
    (_ = 0),
    (u = Math.pow(10, s)),
  l && ((m *= u), (_ *= u)),
    ...
    (y = setInterval(function () {
      var t
      ;(_ += m / 108),
        (f = l ? (Math.round(_) / u).toFixed(s) + '' : Math.floor(_) + ''),
      1 < i.length && (f = f.replace(/(\d)(?=(\d{3})+([^\d]|$))/g, '$1 ')),
      c && (f = f.replace(/\./g, ',')),
      d && (d.textContent = f),
      m <= _ &&
      (clearInterval(y),
  ...
  t.forEach(function (a) {
    ...
    t_animate__assignGroupDelay(a, e),
      Array.prototype.forEach.call(t, function (t) {
        ...
        t.classList.contains('.t-animate__btn-wait-chain') ||
        (t_animate__removeNoHoverClassFromBtns(t),
          e ? t.classList.add('t-animate_wait') : t.classList.add('t-animate_started'))),
...
function t_animate__assignGroupDelay(t, e) {
  ...
  t.querySelectorAll('[data-animate-order]').length
    ...
    : ((a = t.querySelectorAll('.t-img.t-animate')),
      (n = t.querySelectorAll('.t-uptitle.t-animate')),
      ...
      (r = t.querySelectorAll('.t-descr.t-animate')),
      (r = Array.prototype.filter.call(r, function (t) {
        return !t.classList.contains('t-section__descr')
      })),
      (o = t.querySelectorAll('.t-btn.t-animate, .t-btnwrapper.t-animate')),
      (o = Array.prototype.filter.call(o, function (t) {
        return !t.closest('.t-section__bottomwrapper')
      })),
      (e = t.querySelectorAll('.t-timer.t-animate')),
    ...
    n.length && (s += 0.3),
    (n.length || i.length || r.length) && (s += 0.2),
    e.length &&
    Array.prototype.forEach.call(e, function (t) {
      t.style.transitionDelay = s + 's'
    }),
    e.length && (s += 0.5),
    o.length && (o[0].style.transitionDelay = s + 's'),
    2 === o.length && (s += 0.4),
    2 === o.length && (o[1].style.transitionDelay = s + 's'),
    0 !== t.length &&
    Array.prototype.forEach.call(t, function (t) {
      t.style.transitionDelay = s + 's'
    }))
...
function t_animate__assignOrderedElemsDelay(t, e) {
  ...
  (n.length || i.length || r.length || o.length || s.length || l.length || c.length) &&
  e.length &&
  ((a += +t_animate__getAttrByResBase(e[0], 'delay')),
    Array.prototype.forEach.call(e, function (t) {
      t.style.transitionDelay = a + 's'
    })),
  (n.length ||
...
function t_animate__getAttrByResBase(t, e) {
  ...
  return 'y' !== (n ? n.getAttribute('data-animate-mobile') : null)
    ...
    : 960 <= a
      ? t.getAttribute('data-animate-' + e + '-res-960') || t.getAttribute('data-animate-' + e)
      : 640 <= a
...
function t_animate__checkIE() {
  var t,
    ...
    n = !1
  return (
    0 < a && ((8 !== (t = parseInt(e.substring(a + 5, e.indexOf('.', a)))) && 9 !== t) || (n = !0)),
      n
  )
}
